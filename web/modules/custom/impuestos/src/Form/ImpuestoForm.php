...
namespace Drupal\impuesto\Form;

use Drupal\Core\Entity\ContentEntityForm;
use Drupal\Core\Form\FormStateInterface;

/**
 * Formulario para crear y editar la entidad Impuesto.
 */
class ImpuestoForm extends ContentEntityForm {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::messenger()->addMessage($this->t('La entidad Impuesto ha sido guardada.'));
  }
}